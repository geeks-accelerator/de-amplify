...
> **About this page.** Where the record stood as of August 2, 2026, one week into evidence; this is an **active trial** and it will move faster than this page does. Claims are labeled: **court-held** (decided as a matter of law), **jury-found** (verdict returned, appeals possible), **alleged** (the State's contention, not a finding), **requested** (a party's proposed remedy), **scheduled** (a current court date, subject to change). This page is the reader's rendering of the project's evidence-tiered claim ledger for this case; corrections land in the ledger first, then here.

## The case in one paragraph

Tennessee's attorney general sued Meta and Instagram in October 2023 under the Tennessee Consumer Protection Act, pleading both unfair design and deception. A jury was sworn on July 24, 2026, opening statements followed on July 27, and the court's calendar runs the trial to September 3. The distinctive allegation for anyone studying platform safety is a dedicated count about the "Time Spent" tools: the State says Meta learned by March 2020 that the tool showed users materially wrong numbers, that its own team recommended removing it, and that Meta kept it because it was the company's "biggest proof point" on tech addiction. The State's first witness was Arturo Bejar, the same former Meta engineer who testified to the Senate in 2023. The jury decides liability; the Chancellor decides penalties and any design-change order. (As of August 2, 2026.)
...
A jury of fifteen was sworn at 12:06 p.m. on **Friday, July 24, 2026**, after a week of selection, and **opening statements were delivered on Monday, July 27**. Several pre-trial previews said openings would happen on the Friday; they did not. The court's calendar runs trial days through **September 3, 2026**, so this page catches the trial one week into roughly six.
...
That name should be familiar. Bejar is the engineer whose [November 2023 Senate testimony](/distillations/hearing-2023-11-07-teen-mental-health) is one of this site's four hearing records, and he was deposed under a joint caption naming this case. He has now given an account of the same conduct to a Senate subcommittee and to a Nashville jury, two and a half years apart. Whether those two accounts match is the most interesting question this trial raises for this project, and it is one nobody can currently answer: the Senate half is a public transcript, and the trial half is not retrievable at all.
...
And a complaint is an advocacy document. The allegations above are what the State says it will prove. A jury is now hearing that case, but it has heard only the State's half of it, and it has decided nothing.

**The full evidence ledger** behind this page, every claim tiered and traced, is at [the Tennessee v. Meta distillation](/distillations/tennessee-v-meta).

## Sources

Primary: the [unredacted complaint](https://www.tn.gov/content/dam/tn/attorneygeneral/documents/pr/2024/pr24-03-unredactedcomplaint.pdf) published by the Tennessee AG (2024-01-10) and its [announcement](https://www.tn.gov/attorneygeneral/news/2024/1/10/pr23-03.html); the AG's [filing announcement](https://www.tn.gov/attorneygeneral/news/2023/10/24/pr23-48.html) (2023-10-24); the [motion-to-dismiss order](https://storage.courtlistener.com/recap/gov.uscourts.cand.401490/gov.uscourts.cand.401490.683.1.pdf) in full (via the federal MDL docket); the Davidson County Chancery register (case 23-1364-IV); the [Tennessee appellate case history](https://pch.tncourts.gov) for all five interlocutory denials; and the federal deposition-protocol orders. Secondary, for trial status and the week-one section only: Reuters, JURIST, WSMV, The Tennessean, MLex, and Courtroom View Network (whose gavel-to-gavel video of this trial is a paid product, which is why no testimony is quoted here).

---

*Provenance: this page is derived from the project's evidence-tiered claim ledger for this case, built 2026-07-25 from the State's published pleading, one obtained court order, the court's own register, and five appellate orders, and re-seeded 2026-08-02 after the first week of evidence. Corrections flow ledger-first. Everything in the week-one section is secondary reporting and is tiered that way in the ledger; the rest of the page rests on documents. This is an active trial and this page is not live coverage; the as-of line is the honesty backstop. Legal characterizations are directional and for counsel to confirm.*
