...
MDL 3047 gathers thousands of youth-harm lawsuits against Meta, Google, TikTok, and Snap before one California federal judge. The state attorneys general's claims survived summary judgment in June 2026, went to trial on August 18, 2026 in Oakland, and ended four days into evidence: on August 26 the court entered a consent judgment resolving the claims of 51 states and territories. Meta pays up to $16,680,647,753.21 over ten years, of which about 30 percent is contingent on Snap, TikTok and YouTube adopting the same teen time limits and reverts to Meta if they do not, plus $75 million in costs and $459,293,017.80 to settle four Cambridge Analytica-era complaints. The judgment records no admission of liability, and the personal-injury and school-district tracks continue. (As of August 28, 2026.)
...
Two further sums sit outside that table: a **$75 million** cost fund, and **$459,293,017.80** to resolve four Cambridge Analytica-era state complaints that were never part of this case. The arithmetic maximum is therefore about **$17.2 billion**, which is where the various headline figures came from. Coverage on the day reported the total as $16.68 billion, $16.7 billion, $17 billion, $17.1 billion and $18 billion, in outlets of comparable standing.
...
**Phase I applies for five years and is unconditional.** Teen accounts get a default overnight block "from 12 a.m. to 6 a.m.", and a default daily limit "of 2 hours per day" counted cumulatively across Meta's apps. **Phase II applies only "whenever, in the 10 years following the Effective Date, Industry-Wide Adoption has occurred"** for the obligation in question, and widens the overnight block to 10 p.m. to 7 a.m. "Industry-Wide Adoption" means the same three companies being bound to equivalent obligations, by settlement, by statute, or by audited voluntary undertaking.
...
### The Phase I terms read like the scorecard

Whatever else it is, this is the first enforceable American order that writes a feed brake the way [the brake integrity standard](/scorecard) asks for one. The default "cannot be modified to a less restrictive setting without approval from a Supervising Parent", so the teen cannot switch it off. Meta must build the surrounding product so that teens "cannot access broader Meta SMP features (beyond the content in a single message) and effectively circumvent" the limit, which is an anti-circumvention duty rather than a promise. And when the brake engages, the apps "shall not recommend or otherwise suggest that the Teen User utilize a different Meta SMP or engage in messaging": an explicit ban on the sideways nudge into a sibling app.

The rest of the injunctive terms, in the same register. Like and reaction counts: Meta's apps "will, by default, disable Teen Users from seeing numbers of likes or reactions", changeable only by a parent. Cosmetic-procedure filters are disabled for teens outright. A **non-personalized feed** must be offered as a selectable default home feed within four months, re-offered every 90 days, and the agreement forbids a thumb on the scale: Meta "shall not preselect or prioritize accepting or rejecting this switch for the Teen User and shall present this choice independent of other setting options."

Note one asymmetry the coverage blurred: the time limits and the likes counter are **defaults**, while the non-personalized feed is an **option**. A default that must be turned off and an option that must be turned on are not the same remedy.
...
- **What was actually agreed** is in the settlement section above: up to **$16,680,647,753.21** under Exhibit B, of which about 30 percent is contingent on the rest of the industry, plus $75 million in costs and $459,293,017.80 for the Cambridge Analytica-era complaints. Against a theoretical ceiling of $1.4 trillion, the guaranteed money is roughly **eight tenths of one percent**. That comparison is arithmetic, not commentary: a statutory maximum is not a valuation, and the ceiling was Meta's construction of the states' method, not the states' demand.
