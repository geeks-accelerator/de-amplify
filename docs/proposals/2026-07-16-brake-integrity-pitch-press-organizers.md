<!--
Pitch deck: Where's the Brake, for press and organizers.
Audience: journalists, editors, columnists, podcasters, newsletter writers; movement organizers,
advocacy groups, parent networks, campaigners.
Purpose: the boldest room, where attention beats legal defensibility. Leads with the wedge mechanism,
puts the mandated-label anchor ("label the manipulation") on the table as the aggressive demand, models
anchor-high via the states' $1.4T, and hands over a self-demonstrating story + concrete actions.
Discipline held even here: the villain is the MECHANISM, never a company or a tribe (or the deck becomes
...
# The proof is what you feel right now
...
# When they say "censorship," flip it
