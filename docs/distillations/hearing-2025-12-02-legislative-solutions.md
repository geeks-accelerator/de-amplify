...
- **Nav label (~40 chars, for the /distillations index card, breadcrumb, and cross-links):** Dec 2025: the legislative hearing
- **OG title (~50 chars, for the share card):** The 2025 legislative hearing: the full ledger
