---
title: "Congressional Hearing: From the Courtroom to Congress: Landmark Social Media Verdicts (May 13, 2026)"
type: distillation
...
evidentiary_status: >
  ...
  GPO/govinfo verbatim transcript has NOT been published yet (those lag roughly a year). This
  distillation is therefore built from the four OFFICIAL WRITTEN-TESTIMONY PDFs (primary; the
  witnesses' prepared statements), NOT from a verbatim hearing transcript. Consequences a reader
  must hold: (1) the live Q&A is NOT captured here (no quote-bank from the exchange); (2) every
  witness is a plaintiff-side / pro-legislation advocate; this was a one-sided hearing BY DESIGN,
  with NO platform witness and no opposing view present, so witness characterizations carry an
  [advocacy-witness] flag symmetric to the CEO hearing's [interested-party]; (3) the internal
  company documents quoted below are TRIAL EXHIBITS presented by plaintiffs' counsel (Lanier), not
  independently re-verified here; (4) the KGM verdict Lanier describes is ON APPEAL, not final
  (see the lawsuit distillations in this folder). When the official transcript publishes, this doc
  should be rebuilt to the full standard and re-verified.
sycophancy_audit:
  method: "Two-pass blind cross-architecture wedge check (song-review cultural/intuition battery, adapted for a one-sided advocacy hearing: advocacy-not-fact, on-appeal honesty, trial-exhibit fairness, stealth-advocacy) on a NON-CLAUDE model, given this distillation AND the witness-testimony source."
  model: x-ai/grok-4.3
  date: 2026-07-16
  cooperative_verdict: "MIRROR. Mechanism-not-tribe held; [advocacy-witness] flags consistent; on-appeal caveat present; explicit refusal to manufacture balance. No fixes required."
  adversarial_verdict: "LEAN-CONFIRMED. The meticulously-flagged ledger is careful, but the high-level framing sections (reader summary, brake-integrity topic sentences) assert the plaintiff conclusions in the distiller's voice more strongly than the ledger does, and the on-appeal caveat sat too far from the 'juries found liable' claim."
  post_audit_verification: "Adversarial claims substring-checked (verify-the-reviewer). REJECTED: the reviewer quoted the doc asserting 'the documents prove there is nothing frivolous about these lawsuits' (that line does not exist in the doc; it was fabricated when the reviewer pushed to LEAN-CONFIRMED). REJECTED: 'false-balance is attempted' (the doc explicitly refuses to manufacture balance). ACCEPTED (real): the framing-voice leak in the summary + brake sections and the on-appeal proximity. FIXED: softened the summary's liability claim to 'returned verdicts finding... both now on appeal', attributed the exhibits to 'as she presented them' / 'plaintiffs' counsel's sworn testimony (disputed by the companies elsewhere)', changed '30 tools were understood as theater' to 'Meta employees treated the 30 tools as beside the point', re-hedged the convergence sentence, and added 'both on appeal, not final' to the body verdicts claim. Content unchanged; voice given the attribution the ledger already had."
  raw_audit_trail: "reviews/hearing-2026-05-13-wedge-check-r1-cooperative.md ; reviews/hearing-2026-05-13-wedge-check-r2-adversarial.md"
sources:
  - "PRIMARY (official written testimony, verbatim): the four witness testimony PDFs from the Senate Judiciary hearing page, downloaded 2026-05-13 vintage, accessed 2026-07-16; plain-text cached at sources/senate-2026-05-13-testimony-combined.txt. Every quoted span is verified an exact substring of that cache by gitwverse scripts/hearing_quote_check.py. https://www.judiciary.senate.gov/committee-activity/hearings/from-the-courtroom-to-congress-why-landmark-social-media-verdicts-demand-federal-action-to-protect-kids-online"
...
tier_key: "ESTABLISHED = the statement is verbatim in the official written testimony (a fact about what the witness submitted). [advocacy-witness] = a plaintiff-side/pro-legislation witness's characterization, reported not adjudicated (symmetric to the CEO hearing's [interested-party]). [trial-exhibit via advocacy-witness] = an internal company document quoted by Lanier from the KGM trial record, presented by plaintiffs' counsel. OBSERVED = the live Q&A or verdict context carried only by secondary sources. ASSUMED = distiller inference, flagged."
structural_villain: "The design and the incentive, and the Section 230 shield that removes the accountability which would force a fix; the same villain the other two hearings named, here evidenced by the companies' own internal documents. Not a party; not the companies as people."
---

## Reader summary (derived, plain text)

On May 13, 2026, a Senate Judiciary subcommittee held a hearing built around two things that had not existed before: American juries had returned verdicts finding Meta, Google, and Instagram liable for designing products that harmed children (the California KGM verdict and the New Mexico verdict, both now on appeal). The witness who tried the California case, Rachel Lanier, walked the committee through the internal company documents she had put before the jury. Those documents, as she presented them, are the heart of this record: a 2016 YouTube presentation stating the goal to be "an app that is...Addictive"; a 2012 YouTube note that the metric was "not viewership, it's viewer addiction"; a 2020 Meta email calling the company's inability to enforce its own under-13 rule "just indefensible" and saying the product team would not prioritize a fix "until we're legally required to do it"; and a 2023 Meta employee chat, reacting to the state lawsuits, in which staff say the recommendation algorithm optimizes teen engagement "as with everyone else" and that "nobody is asking us to build 30 tools." That last one directly answers the "30 tools" Meta's CEO cited to this same body sixteen months earlier. A law professor framed the legal cause (Section 230 removes the deterrence that would force safety), and two parents who lost children asked Congress to pass the Kids Online Safety Act. Three cautions define what this document is and is not (see evidentiary_status in full): the official transcript is not published yet, so this is built from the witnesses' written statements, not the live Q&A; every witness was a plaintiff-side advocate and no platform was present to answer; and the verdict Lanier describes is on appeal, not final. As of the date above, this reflects that written record.
...
- [ESTABLISHED] It was convened around two jury verdicts: the California KGM v. Meta and Google case (which Lanier tried) and the New Mexico case, both distilled separately in this folder and both on appeal, not final. (Lanier and Leary testimony.)
...
- [ESTABLISHED] Leary cited NCMEC's 2024 CyberTipline figure of 29.2 million reports of suspected child sexual exploitation, and a 192% increase in online-enticement reports. [lawmaker/expert characterization citing NCMEC] (Leary testimony.)
...
- "Children's brains are being hijacked, and big tech built it that way by design." [thesis, stated by trial counsel] (written testimony)
- "The children using these products were not customers. They were the product." [mechanism: the business model] (written testimony)
- "if we want to win big with teens, we must bring them in as tweens." [trial exhibit: Meta internal document on youth acquisition] (written testimony, quoting a Meta exhibit)
- "We aspire to be an app that is...Addictive" [trial exhibit: 2016 YouTube internal presentation] (written testimony, quoting exhibit EX. 04502.00011)
- "would not prioritize this proactive work until we're legally required to do it" [trial exhibit: 2020 Meta age-enforcement email; the missing incentive in Meta's own words] (written testimony, quoting exhibit EX. 00009)
- "nobody is asking us to build 30 tools" [trial exhibit: 2023 Meta employee chat; the internal view that the safety tools were beside the point] (written testimony, quoting exhibit EX. 00091)

### Mary Graw Leary (Professor of Law) [advocacy-witness]

- "they face no deterrence for designing products without regard to safety. Rather, the system incentivizes them to increase engagement through any means necessary" [the Section 230 mechanism: the missing brake by law] (written testimony)

### The parents [advocacy-witness]

- "I'm here today to ask Congress to finish the job and pass KOSA" Joann Bogard, mother of Mason (written testimony)
...
- **What this distillation is built from.** The four official written-testimony PDFs (Lanier, Leary, Bogard, Norring), verbatim. The live Q&A is deliberately not quoted (no official transcript; the secondary cleaned transcript is a reading aid only).
- **Balance within a one-sided source (the anti-wedge discipline).** Because the hearing itself carried only one side, the honest move is not to manufacture balance but to disclose the imbalance and point outward: the villain is kept as the design/incentive/230-shield (which Lanier herself frames as "by design," not as a party), every witness carries the [advocacy-witness] flag, the on-appeal posture is stated, and the CEO hearing (the platforms' answer) and the lawsuit distillations (the legal posture) are cross-referenced for the other side. A proper-noun/party swap does not change the finding, because the finding is about a mechanism the companies documented internally, not about who is prosecuting it.
- **Survivor testimony handled at the mechanism level.** Bogard and Norring testified to the loss of their children; this distillation names the platform's role in the mechanism (a viral-challenge feed; a drug-dealer connection) and their legislative ask, and does not reproduce the grief in detail.
- **Cross-hearing convergence is the point.** The strongest items here (the "30 tools" internal chat vs the CEO's "30 tools" testimony; the cosmetic-AR-filter email vs the court documents Sen. Butler cited; the four-million-under-13 estimate vs the CEO's claim that under-13s are not allowed) are where this hearing's trial evidence meets the CEO hearing's live testimony. That convergence is this document's main value.
- **Known un-mined material.** The witnesses' QFR (questions-for-the-record) responses and the full exhibit set behind Lanier's citations are not distilled here; and the official transcript, when published, will add the Q&A.
