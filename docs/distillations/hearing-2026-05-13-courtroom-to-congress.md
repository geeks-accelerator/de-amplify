...
sycophancy_audit:
  ...
  post_audit_verification: "Adversarial claims substring-checked (verify-the-reviewer). REJECTED: the reviewer attributed to this doc the line 'the documents prove there is nothing frivolous about these lawsuits', which is not in the doc. CORRECTED BY THE FULL-SET REVIEW (same day): that line exists VERBATIM in the witness testimony (Norring), so the failure was doc/source MISATTRIBUTION, not invention as first recorded here; mitigation refined to require a doc locator from any reviewer for claimed doc text. REJECTED: 'false-balance is attempted' (the doc explicitly refuses to manufacture balance). ACCEPTED (real): the framing-voice leak in the summary + brake sections and the on-appeal proximity. FIXED: softened the summary's liability claim to 'returned verdicts finding... both now on appeal', attributed the exhibits to 'as she presented them' / 'plaintiffs' counsel's sworn testimony (disputed by the companies elsewhere)', changed '30 tools were understood as theater' to 'Meta employees treated the 30 tools as beside the point', re-hedged the convergence sentence, and added 'both on appeal, not final' to the body verdicts claim. Content unchanged; voice given the attribution the ledger already had. SECOND CORRECTION (full-set review, same day): the 'both now on appeal' phrasing that wedge-fix introduced was itself WRONG for New Mexico (Meta had announced intent to appeal, not filed, per the sibling new-mexico-v-meta.md ledger) and misdescribed the NM verdict's basis; both corrected against the lawsuit distillations. Lesson recorded in the plan as correction-recoil: a fix pass is itself an ungated edit surface, and corrective edits that add factual claims must be sourced like original claims."
...
## TLDR (summary surfaces, plain text, derived from the ledger; this is a TIER-DOWN doc built from written testimony, and the verdicts it describes are not final, see evidentiary_status)

- **One line (label):** In 2026 the lawyer who won California's child-safety verdict against Meta and Google (now on appeal) showed the Senate the companies' internal documents.
- **Search snippet (~155 chars, for the meta-description tag):** In 2026 lawyer Rachel Lanier showed the Senate internal Meta and Google documents: an addiction goal, and an under-13 rule called indefensible inside Meta.
- **One sentence (card):** In May 2026 Rachel Lanier, the trial lawyer who won California's KGM verdict against Meta and Google (a verdict now on appeal), walked a Senate subcommittee through the internal company documents she had put before the jury, a YouTube goal to be "Addictive", a Meta email calling its own unenforced under-13 rule "just indefensible", and a Meta employee chat saying "nobody is asking us to build 30 tools", to argue Congress should act.
- **One paragraph (meta description):** In May 2026 a Senate subcommittee heard from Rachel Lanier, the trial lawyer who won California's KGM verdict against Meta and Google, along with a law professor and two parents who lost children, to press Congress for child-safety legislation. The hearing's evidence is the internal company documents the jury was shown: a YouTube goal to be "Addictive", a Meta email calling the company's unenforced under-13 rule "just indefensible", and a Meta employee chat saying "nobody is asking us to build 30 tools". Every witness came as an advocate for legislation and no platform was present to answer, and the verdicts are not final: the California verdict is on appeal, and Meta has said it will appeal New Mexico's. (As of July 16, 2026.)
