...
verified_by: "2026-07-16 external-validation audit (internal docs/issues/2026-07-16-lawsuit-distillations-validation-audit.md); court/judge/proceeding verified against the LA Superior Court's own public notice (primary); the verdict, post-trial ruling, appeals, and settlements are wire-corroborated but not docket-confirmed (the Court of Appeal portal blocks automated lookups). A counsel / docket pass remains the gold standard."
---
...
- **What the 2026-07-16 audit added** (full record: internal docs/issues/2026-07-16-lawsuit-distillations-validation-audit.md): the LA Superior Court's own public notice as a true primary for the proceeding, department, and judge; the June 9/10 date ambiguity (D-4); the June 23 YouTube settlement correction (D-5); the D-1 resolution (TikTok June 30); the derived July 7 date for Meta's notice of appeal; the composition of the ~1,600 (families and school districts included); and confirmation that the two Kuhl-ruling quotes remain plaintiff-side-sourced only.
