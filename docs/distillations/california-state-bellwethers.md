...
verified_by: "2026-07-16 external-validation audit; court/judge/proceeding verified against the LA Superior Court's own public notice (primary); the verdict, post-trial ruling, appeals, and settlements are wire-corroborated but not docket-confirmed (the Court of Appeal portal blocks automated lookups). A counsel / docket pass remains the gold standard."
---
...
- **Nav label (~40 chars, for the /distillations index card, breadcrumb, and cross-links):** K.G.M. and the California bellwethers
- **OG title (~50 chars, for the share card):** The California bellwethers: the evidence ledger
- **Search snippet (~155 chars, for the meta-description tag):** California's first test verdict hit Meta and Google for $6 million over addictive app design; both are appealing, and the second test case never reached a jury.
- **Ledger snippet (~155 chars, for the /distillations/<slug> meta description ONLY; keeps the search snippet to a single consumer):** The evidence record behind the K.G.M. verdict: every figure traced to the docket or a primary release, with the settlement dates and appeal posture kept separate.
...
14. **[ESTABLISHED]** Both defendants have filed notices of appeal of the K.G.M. verdict. *(Verified baseline; AP via Washington Times / Las Vegas Sun / Fortune.)*
...
16. **[ESTABLISHED]** YouTube (Google) filed its notice of appeal on Monday, July 13, 2026, in Los Angeles County Superior Court. *(AP, dated July 15, 2026: filed "Monday," which was July 13; Fortune adds YouTube's argument that it is not a social media platform.)*
...
- **D-1: TikTok settlement date. RESOLVED (2026-07-16).** Baseline said TikTok settled "early July" 2026. Sources (The Next Web crediting Bloomberg; NBC News) put it on **Tuesday, June 30, 2026**. The audit adopted June 30 and the deployed website content (policy paper §1, content pages) was corrected from "early July" to June 30 on 2026-07-16. The original flag was recorded here rather than overwritten, which is what made the clean adjudication possible.

- **D-2: "Florida teen" framing of the second bellwether (the flagged trap).** Some coverage of the TikTok settlement (e.g., NBC News's headline, The Next Web's URL slug) foregrounds that the second-bellwether plaintiff, R.K.C. / "Russell," is a **Florida teen**. This could be misread as a *separate Florida court case*. Per the sources here it is NOT: the second bellwether is the **California** JCCP 5255 test case, tried in Los Angeles Superior Court before Judge Carolyn Kuhl; the plaintiff simply *resides* in Florida. Recorded as a clarification, not a conflict.

- **D-3: One secondary summary mislabeled the second bellwether as "federal MDL."** The Next Web described the second bellwether as a "federal multidistrict litigation (MDL) in Los Angeles." That characterization is **rejected here as unreliable**: the same summary names **Judge Carolyn Kuhl**, a Los Angeles *Superior Court* (state) judge, and the LASC's own notice plus The Recorder frame the matter as the California state coordinated proceeding. The federal MDL (MDL 3047) is a distinct proceeding before a different judge in Oakland and must not be merged in. Logged so the error is not silently carried forward.

- **D-4: Post-trial denial date (added by the 2026-07-16 audit).** The baseline and an earlier version of this record stated the denial as **June 10, 2026** as an established fact. Reuters' wire reports the ruling was made "on Tuesday" (June 9); June 10 is the announcement/coverage date. Same class as the coverage-date-as-event-date errors found elsewhere in this project (the MDL order's June 29/30; New Mexico's May 21/22). All surfaces now say "early June (announced June 10)" pending the minute order.

- **D-5: YouTube second-bellwether settlement date (added by the 2026-07-16 audit).** The baseline and an earlier version said **June 24**; that is The Recorder's publication date. The settlement was reported **Tuesday, June 23**. Deployed content corrected on 2026-07-16.

- No conflicts found on the core load-bearing facts: the $6M total, the $3M/$3M compensatory-punitive split, the 70/30 Meta/Google allocation ($4.2M / $1.8M), the March 25, 2026 verdict date, the fact of the new-trial and JNOV denials, the appeals-filed-not-affirmed posture, the July 13 YouTube appeal, the July 27 second-bellwether trial date, and the Meta-and-Snap-remaining lineup all match the baseline and the corroborating coverage.
...
- **What the 2026-07-16 audit added:** the LA Superior Court's own public notice as a true primary for the proceeding, department, and judge; the June 9/10 date ambiguity (D-4); the June 23 YouTube settlement correction (D-5); the D-1 resolution (TikTok June 30); the derived July 7 date for Meta's notice of appeal; the composition of the ~1,600 (families and school districts included); and confirmation that the two Kuhl-ruling quotes remain plaintiff-side-sourced only.
- **Unfetchable / degraded sources.** Direct fetches failed on: CNBC (HTTP 403), Law.com/The Recorder (HTTP 403; paywalled even in archive), NBC News (403), U.S. News (timeouts), NPR's main site (timeout; the text edition text.npr.org worked), Business & Human Rights Resource Centre (504), and the California Court of Appeal portal (appellatecases.courtinfo.ca.gov rejects automated queries; a human party search for "Meta Platforms" in the Second Appellate District is the cleanest way to pin the appeal dockets). web.archive.org is not fetchable from this tooling. No load-bearing fact rests on a single blocked source alone.
- **No signed order or verdict form was directly read.** The LASC public notice is a court-issued document (primary for court/judge/proceeding), but no order PDF, verdict form, or docket sheet was directly viewed. The [ESTABLISHED] tier rests on the tier key above (primary notice + verified baseline + independent corroboration); a human primary-source pass (the signed post-trial order; the notices of appeal; the JCCP 5255 docket) is still recommended before the record is treated as authoritative, hence the verified_by caveat.
