...
const ledgerLinks = DISTILLATIONS.map((d) => ({
  href: `${SITE}/distillations/${d.slug}`,
  markdown: `${SITE}/distillations/${d.slug}.md`,
  title: loadDistillation(d.slug).navLabel,
  kind: d.kind,
  ...(d.tierDown ? { tierDown: true } : {}),
}));
...
const BODY = {
  ...
  _links: {
    ...
    audiences: [
      { href: `${SITE}/for/policymakers`, markdown: `${SITE}/for/policymakers.md`, title: "For policymakers" },
      { href: `${SITE}/for/parents`, markdown: `${SITE}/for/parents.md`, title: "For parents" },
      { href: `${SITE}/for/press`, markdown: `${SITE}/for/press.md`, title: "For press and organizers" },
    ],
    cases: [
